void sendInverterRead_ABB33K(void) {  
    unsigned int retVal;
    char sendBuff[10];   
...
//put_str(0,0,str,1);
                ...
                if (rxCrc == calCrc) {
                	...
                	inverter[invNo].solar_cell_voltage  = Bytes_to_Uint(rxbuff[9],rxbuff[10]); 
					inverter[invNo].solar_cell_current  = Bytes_to_Uint(rxbuff[23],rxbuff[24]);            
                	inverter[invNo].power_solar         = Bytes_to_Uint(rxbuff[15],rxbuff[16]); 
                	inverter[invNo].inv_u_voltage     	= Bytes_to_Uint(rxbuff[105],rxbuff[106]); 
                	inverter[invNo].inv_v_voltage    	= Bytes_to_Uint(rxbuff[107],rxbuff[108]); 
                	inverter[invNo].inv_w_voltage     	= Bytes_to_Uint(rxbuff[109],rxbuff[110]);
                    inverter[invNo].inv_u_current      	= Bytes_to_Uint(rxbuff[11],rxbuff[12]);
                	inverter[invNo].inv_v_current      	= Bytes_to_Uint(rxbuff[11],rxbuff[12]);
                	inverter[invNo].inv_w_current      	= Bytes_to_Uint(rxbuff[11],rxbuff[12]);
                	inverter[invNo].power_inv_now       = Bytes_to_Uint(rxbuff[17],rxbuff[18]);  
                    inverter[invNo].power_inv_pf        = 999;
                    inverter[invNo].inv_frequency       = Bytes_to_Uint(rxbuff[13],rxbuff[14]);
                    ...
                    if ((rxbuff[97] == 0) && (rxbuff[98] < 10)) {
                    	inverter[invNo].power_inv_total     = Bytes_to_Uint(rxbuff[97],rxbuff[98]);
	                    inverter[invNo].power_inv_total   <<= 16; 
                    }
                    
                	inverter[invNo].power_inv_total    += Bytes_to_Uint(rxbuff[95],rxbuff[96]); 

                    inverter[invNo].inverter_status[0] = Bytes_to_Uint(rxbuff[39],rxbuff[40]);	//Main status word             
                    inverter[invNo].inverter_status[1] = Bytes_to_Uint(rxbuff[3],rxbuff[4]);	//Inverter operation            
                    inverter[invNo].inverter_status[2] = Bytes_to_Uint(rxbuff[25],rxbuff[26]);	//Tripping fault              
                    inverter[invNo].inverter_status[3] = Bytes_to_Uint(rxbuff[37],rxbuff[38]);	//Lastest warning	             
                
                    if (inverter[invNo].solar_cell_voltage > 9999) inverter[invNo].solar_cell_voltage = 0; 
                    if (inverter[invNo].solar_cell_current > 9999) inverter[invNo].solar_cell_current = 0; 
                    if (inverter[invNo].power_solar > 9999) inverter[invNo].power_solar = 0; 
                    if (inverter[invNo].inv_u_current > 9999) inverter[invNo].inv_u_current = 0; 
                    if (inverter[invNo].inv_v_current > 9999) inverter[invNo].inv_v_current = 0; 
                    if (inverter[invNo].inv_w_current > 9999) inverter[invNo].inv_w_current = 0; 
                    if (inverter[invNo].power_inv_now > 9999) inverter[invNo].power_inv_now = 0; 
