...
//                    lim[0] = Bytes_to_Uint(rxbuff[39],rxbuff[40]);
//                    lim[0] << 16;                                 
//                    lim[0] += Bytes_to_Uint(rxbuff[37],rxbuff[38]);
					uLong.cc[3] = rxbuff[39];
					uLong.cc[2] = rxbuff[40];
					uLong.cc[1] = rxbuff[37];
					uLong.cc[0] = rxbuff[38];
                    inverter[invNo].power_solar = (unsigned int)(uLong.ff / 10);
//sprintf(str,"%02X,%02X,%02X,%02X  ",rxbuff[37],rxbuff[38],rxbuff[39],rxbuff[40]);
//put_str(0,0,str,1);
...
//                    lim[0] = Bytes_to_Uint(rxbuff[67],rxbuff[68]);
//                    lim[0] << 16;                                 
//                    lim[0] += Bytes_to_Uint(rxbuff[65],rxbuff[66]);
					uLong.cc[3] = rxbuff[67];
					uLong.cc[2] = rxbuff[68];
					uLong.cc[1] = rxbuff[65];
					uLong.cc[0] = rxbuff[66];
                    inverter[invNo].power_inv_now = (unsigned int)(uLong.ff / 10);
