...
void sendInverterRead_WillingsMbusB(void) {
    unsigned int retVal;
    char sendBuff[10];   
...
//-----------------------------------------------------
        case 20:    
            ...
            break;             
        case 21:     //Inv2-1: RTU Master request frame (from WILLINGS_MBUS)  
            sendBuff[0] = 31; //0x15;
            sendBuff[1] = 0x04;
            sendBuff[2] = 0x00;
            sendBuff[3] = 0x18;
        ...
        case 25:    
            ...
            break;        
        case 26:     //Inv2-2: RTU Master request frame (from WILLINGS_MBUS)  
            sendBuff[0] = 32; //0x16;
            sendBuff[1] = 0x04;
            sendBuff[2] = 0x00;
            sendBuff[3] = 0x18;
...
//-----------------------------------------------------
        case 30:    
            ...
            break;             
        case 31:     //Inv2-3 : RTU Master request frame (from WILLINGS_MBUS)  
            sendBuff[0] = 41; //0x21;
            sendBuff[1] = 0x04;
            sendBuff[2] = 0x00;
            sendBuff[3] = 0x18;
        ...
        case 35:    
            ...
            break;        
        case 36:     //Inv2-4 : RTU Master request frame (from WILLINGS_MBUS)  
            sendBuff[0] = 42; //0x22;
            sendBuff[1] = 0x04;
            sendBuff[2] = 0x00;
            sendBuff[3] = 0x18;
...
//-----------------------------------------------------
        case 40:    
            ...
            break;             
        case 41:     //Inv3-1 : RTU Master request frame (from WILLINGS_MBUS)  
            sendBuff[0] = 51; //0x23;
            sendBuff[1] = 0x04;
            sendBuff[2] = 0x00;
            sendBuff[3] = 0x18;
        ...
        case 45:    
            ...
            break;        
        case 46:     //Inv3-2: RTU Master request frame (from WILLINGS_MBUS)  
            sendBuff[0] = 52; //0x24;
            sendBuff[1] = 0x04;
            sendBuff[2] = 0x00;
            sendBuff[3] = 0x18;
...
//-----------------------------------------------------
        case 50:    
            ...
            break;             
        case 51:     //Inv3-3 : RTU Master request frame (from WILLINGS_MBUS)  
            sendBuff[0] = 61; //0x31;
            sendBuff[1] = 0x04;
            sendBuff[2] = 0x00;
            sendBuff[3] = 0x18;
        ...
        case 55:    
            ...
            break;        
        case 56:     //Inv3-4 : RTU Master request frame (from WILLINGS_MBUS)  
            sendBuff[0] = 62; //0x32;
            sendBuff[1] = 0x04;
            sendBuff[2] = 0x00;
            sendBuff[3] = 0x18;
...
//-----------------------------------------------------
        case 60:    
            ...
            break;             
        case 61:     //Inv4-1 : RTU Master request frame (from WILLINGS_MBUS)  
            sendBuff[0] = 71; //0x33;
            sendBuff[1] = 0x04;
            sendBuff[2] = 0x00;
            sendBuff[3] = 0x18;
        ...
        case 65:    
            ...
            break;        
        case 66:     //Inv4-2 : RTU Master request frame (from WILLINGS_MBUS)  
            sendBuff[0] = 72; //0x34;
            sendBuff[1] = 0x04;
            sendBuff[2] = 0x00;
            sendBuff[3] = 0x18;
...
void rx0Control_WillingsMbusB(void) {
    //char imc;        
...
//                put_str(0,0,str,1);         
                ...
                if( (rxbuff[0] == 11) || (rxbuff[0] == 12)) { //1번 인버터 (모듈 2개)
                	invNo = rxbuff[0] - 11;	//0, 1
                } else if( (rxbuff[0] == 21) || (rxbuff[0] == 22)) {  
                	invNo = rxbuff[0] - 19; //2, 3
                } else if( (rxbuff[0] == 31) || (rxbuff[0] == 32)) {  
                	invNo = rxbuff[0] - 27; //4, 5
                } else if( (rxbuff[0] == 41) || (rxbuff[0] == 42)) {  
                	invNo = rxbuff[0] - 35; //6,7
                } else if( (rxbuff[0] == 51) || (rxbuff[0] == 52)) {  
                	invNo = rxbuff[0] - 43; //8, 9
                } else if( (rxbuff[0] == 61) || (rxbuff[0] == 62)) {  
                	invNo = rxbuff[0] - 51; //10, 11
                } else if( (rxbuff[0] == 71) || (rxbuff[0] == 72)) {  
                	invNo = rxbuff[0] - 59; //12, 13
                }            
