...
//1부터 시작
void sendInverterRead_DassTechNew(void) {
    switch(inverter_seq) {
        case 0:
            inverter_seq++;
			if (sendInverterCount[0] < 100) {
...
void send_system_parameter(void) {
	unsigned char chksum8;
    //putchar0(0x02); 
    								chksum8 = 0x02;
    putchar0(0xa5);					chksum8 ^= 0xa5;
    putchar0(eePortNumber/0x100);	chksum8 ^= (eePortNumber/0x100);
    putchar0(eePortNumber%0x100);	chksum8 ^= (eePortNumber%0x100);
    putchar0(0);					chksum8 ^= (0);
    putchar0(eeSendDelay/1000);		chksum8 ^= (eeSendDelay/1000);  
    putchar0(eeInverterCount);		chksum8 ^= (eeInverterCount);
    putchar0(0x03);					chksum8 ^= 0x03;
    putchar0(chksum8);
    putchar0(0x0d);
...
void rx0Control_DassTechAll(void) {   
	char rxdata;
	rxdata = getchar0();
...
//sprintf(str,"RX_seq:%02d ST1 ",rx_seq0); buzzer_flag |= BUZZER_TIC; tx_led_delay = 1000; put_str(0,0,str,1);
                ...
                if ( (modelInverter == MODEL_INVERTER_DASSTECH100K) || (modelInverter == MODEL_INVERTER_DASSTECH100KN) ) {
                ...
                if ((modelInverter == MODEL_INVERTER_DASSTECH500K) || (modelInverter == MODEL_INVERTER_DASSTECH3K) || 
                 (modelInverter == MODEL_INVERTER_DASSTECH500KN) || (modelInverter == MODEL_INVERTER_DASSTECH3KN)) {
...
//        	} else 
        ...
        case 42:
            ...
            if (rcnt == 16) {
                ...
                if ( (modelInverter == MODEL_INVERTER_DASSTECH500K) || (modelInverter == MODEL_INVERTER_DASSTECH500KN) ){
        ...
        case 162:
            ...
            if (rcnt == 12) {  
                ...
                if (rxbuff[8] < 0x3a) { 
                    ...
                    dCalSum += (rxbuff[8] - 0x37);
                } 
                
                dCrcSum = (rxbuff[10] - 0x30);
                dCrcSum *= 10;
                ...
                if (dCalSum == dCrcSum) {                         
                    ...
                    if (rxbuff[8] < 0x3a) {
                        ...
                        inverter[imInvNo].inverter_status[2] = rxbuff[8] - 0x37;
                    }
                    inverter[imInvNo].inverter_status[3] = 0;
