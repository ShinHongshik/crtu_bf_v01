...
void sendInverterRead_WillingsMBUS(void) {
    unsigned int retVal;
    char sendBuff[10];   
...
//-----------------------------------------------------
        case 60:    
            ...
            break;             
        case 61:     //Inv-11 (2-5): RTU Master request frame (from WILLINGS_MBUS)  
            sendBuff[0] = 0x33;
            sendBuff[1] = 0x04;
            sendBuff[2] = 0x00;
            sendBuff[3] = 0x18;
        ...
        case 65:    
            ...
            break;        
        case 66:     //Inv-12 (2-6): RTU Master request frame (from WILLINGS_MBUS)  
            sendBuff[0] = 0x34;
            sendBuff[1] = 0x04;
            sendBuff[2] = 0x00;
            sendBuff[3] = 0x18;
...
void rx0Control_WillingsMBUS(void) {
    //char imc;        
...
//                put_str(0,0,str,1);         
                ...
                if( (rxbuff[0] > 0x10) && (rxbuff[0] < 0x17)) { 
                	...
                	invNo = rxbuff[0] - 0x1B;
                } else if( (rxbuff[0] > 0x30) && (rxbuff[0] < 0x37)) {  
                	invNo = rxbuff[0] - 0x27;
                }            
