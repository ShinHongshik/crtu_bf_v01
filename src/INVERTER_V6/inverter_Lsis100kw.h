void sendInverterRead_Lsis100K(void) {
    switch(inverter_seq) {
        case 0:
        ...
        case 5:     //Inv-1:Solar and INV power
            ...
            inverter_seq++;
            break;                       
        case 6:     //Inv-1:Solar TOTAL POWER 
            inv_command = 0x25;		//01 03 00 19 00 06 14 0F =>01 03 0c 00 54 00 51 01 24 03 6a 00 16 0e 30 2e 96  
            putchar0(0x03);
            putchar0(0x00);
            putchar0(inv_command);
            putchar0(0x00);
        ...
        case 15:     //Inv-2:Solar and INV power
            ...
            break;                       
        case 16:    
         //Inv-2:Solar TOTAL POWER 
            inv_command = 0x25;		//02 03 00 19 00 06 14 0F =>02 03 0c 00 54 00 51 01 24 03 6a 00 16 0e 30 2e 96  
            putchar0(0x03);
            putchar0(0x00);
            putchar0(inv_command);
            putchar0(0x00);
        ...
        case 25:     //Inv-3:Solar and INV power
            ...
            inverter_seq++;
            break;                       
        case 26: //Inv-3:Solar TOTAL POWER 
            inv_command = 0x25;		//03 03 00 19 00 06 14 0F =>03 03 0c 00 54 00 51 01 24 03 6a 00 16 0e 30 2e 96  
            putchar0(0x03);
            putchar0(0x00);
            putchar0(inv_command);
            putchar0(0x00);
        ...
        case 35:     //Inv-4:Solar and INV power
            ...
            inverter_seq++;
            break;                       
        case 36:      //Inv-4:Solar TOTAL POWER 
            inv_command = 0x25;		//04 03 00 19 00 06 14 0F =>04 03 0c 00 54 00 51 01 24 03 6a 00 16 0e 30 2e 96  
            putchar0(0x03);
            putchar0(0x00);
            putchar0(inv_command);
            putchar0(0x00);
        ...
        case 45:     //Inv-5:Solar and INV power
            ...
            inverter_seq++;
            break;                       
        case 46:    //Inv-5:Solar TOTAL POWER 
            inv_command = 0x25;		//05 03 00 19 00 06 14 0F =>05 03 0c 00 54 00 51 01 24 03 6a 00 16 0e 30 2e 96  
            putchar0(0x03);
            putchar0(0x00);
            putchar0(inv_command);
            putchar0(0x00);
        ...
        case 55:     //Inv-6:Solar and INV power
            ...
            inverter_seq++;
            break;                       
        case 56:    //Inv-6:Solar TOTAL POWER 
            inv_command = 0x25;		//06 03 00 19 00 06 14 0F =>06 03 0c 00 54 00 51 01 24 03 6a 00 16 0e 30 2e 96  
            putchar0(0x03);
            putchar0(0x00);
            putchar0(inv_command);
            putchar0(0x00);
        ...
        case 65:     //Inv-7:Solar and INV power
            ...
            inverter_seq++;
            break;                       
        case 66: //Inv-7:Solar TOTAL POWER 
            inv_command = 0x25;		//07 03 00 19 00 06 14 0F =>07 03 0c 00 54 00 51 01 24 03 6a 00 16 0e 30 2e 96  
            putchar0(0x03);
            putchar0(0x00);
            putchar0(inv_command);
            putchar0(0x00);
        ...
        case 75:     //Inv-8:Solar and INV power
            ...
            inverter_seq++;
            break;                       
        case 76: //Inv-8:Solar TOTAL POWER 
            inv_command = 0x25;		//08 03 00 19 00 06 14 0F =>08 03 0c 00 54 00 51 01 24 03 6a 00 16 0e 30 2e 96  
            putchar0(0x03);
            putchar0(0x00);
            putchar0(inv_command);
            putchar0(0x00);
        ...
        case 85:     //Inv-9:Solar and INV power
            ...
            inverter_seq++;
            break;                       
        case 86:    //Inv-9:Solar TOTAL POWER 
            inv_command = 0x25;		//09 03 00 19 00 06 14 0F =>09 03 0c 00 54 00 51 01 24 03 6a 00 16 0e 30 2e 96  
            putchar0(0x03);
            putchar0(0x00);
            putchar0(inv_command);
            putchar0(0x00);
        ...
        case 95:     //Inv-10:Solar and INV power
            ...
            inverter_seq++;
            break;                       
        case 96:  //Inv-A:Solar TOTAL POWER 
            inv_command = 0x25;		//0A 03 00 19 00 06 14 0F =>0A 03 0c 00 54 00 51 01 24 03 6a 00 16 0e 30 2e 96  
            putchar0(0x03);
            putchar0(0x00);
            putchar0(inv_command);
            putchar0(0x00);
...
//                inverter[imInvNo].power_inv_total    += ((unsigned long int)rxbuff[11] * 0x100 + (unsigned long int)rxbuff[12])/100;
            ...
            break;
        case 60:	////01 03 00 19 00 06 14 0F =>01 03 0c 00 54 00 51 01 24 03 6a 00 16 0e 30 2e 96
        	rxbuff[rcnt++] = rxdata;       
            if (rcnt == 9) {

                inverter[imInvNo].power_inv_total     = ((unsigned long int)rxbuff[1] * 0x100 + rxbuff[2])*10000;
                inverter[imInvNo].power_inv_total     += ((unsigned long int)rxbuff[3] * 0x100 + rxbuff[4])*100;
                inverter[imInvNo].power_inv_total     += ((unsigned long int)rxbuff[5] * 0x100 + rxbuff[6])/100;

                inverter[imInvNo].power_inv_pf        = 995;

                sendInverterCount[imInvNo] = 0;
	            buzzer_flag |= BUZZER_TIC;
                sprintf(str,"RX%01X", imInvNo+1);
            	put_str(4,16,str,1);   
        	    rx_led_delay = 2500;
                inv_command = 0;
                rx_seq0 = 0;
