...
//-----------------------------------------------------
        ...
        case 21:     //Inv2-1: RTU Master request frame (from WILLINGS_MBUS)  
            sendBuff[0] = 0x15;
            if(modelInverter == MODEL_INVERTER_WILLINGSMBUS_B5)     //61
                sendBuff[0] = 15;
            sendBuff[1] = 0x04;
            sendBuff[2] = 0x00;
            sendBuff[3] = 0x18;
...
//                put_str(0,0,str,1);         
                ...
                if( (rxbuff[0] > 10) && (rxbuff[0] < 16)) { 
                	invNo = rxbuff[0] - 11;
                } else if( (rxbuff[0] > 20) && (rxbuff[0] < 25)) {  
                	invNo = rxbuff[0] - 17;
                } else if( (rxbuff[0] > 30) && (rxbuff[0] < 35)) {  
                	invNo = rxbuff[0] - 23;
                }            
                ...
                temp = (inverter[invNo].solar_cell_voltage * inverter[invNo].solar_cell_current)/1000;
                ...
                inverter[invNo].power_solar			= (unsigned int)(fdata.value/100)/10*variable;// / 10;   
